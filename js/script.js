 ...
 * Tick labels move dynamically, while the red marker is positioned at the rocket's center.
 */
 ...
 * The red marker is positioned using the rocket-wrapper’s offsetTop (its position relative to the container).
 */
function updateVerticalTicker() {
  ...
  // Use offsetTop to position the red marker exactly at the rocket's center Y.
  const rocketWrapper = document.getElementById("rocket-wrapper");
...
/**
 * Update the display above the rocket and the current run box.
 */
